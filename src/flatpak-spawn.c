      ...
      char **argv)
{
  ...
  const GOptionEntry options[] = {
    ...
    { "sandbox-expose", 0, G_OPTION_FLAG_FILENAME, G_OPTION_ARG_STRING_ARRAY, &opt_sandbox_expose, "Expose access to named file", "NAME" },
    { "sandbox-expose-ro", 0, G_OPTION_FLAG_FILENAME, G_OPTION_ARG_STRING_ARRAY, &opt_sandbox_expose_ro, "Expose readonly access to named file", "NAME" },
